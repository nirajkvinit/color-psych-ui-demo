...
type PaletteKey = 'calm' | 'warm' | 'verdant' | 'lumina';
...
const getChartData = () => {
  return [
    { palette: 'Aether Calm', calmness: 8.7, premium: 8.4 },
    { palette: 'Ember Prof.', calmness: 6.8, premium: 7.5 },
    { palette: 'Verdant', calmness: 8.9, premium: 8.8 },
    { palette: 'Lumina', calmness: 8.4, premium: 8.9 },
  ];
};
...
const App: React.FC = () => {
  ...
  const stats = [
    { label: "Trust Score", value: currentPaletteKey === 'calm' || currentPaletteKey === 'verdant' ? "94" : "81", unit: "%", icon: ShieldCheck, trend: "+12%" },
    { label: "User Calm Rating", value: currentAvgCalm > 0 ? currentAvgCalm.toFixed(1) : "8.4", unit: "/10", icon: Heart, trend: "+0.3" },
    { label: "Premium Perception", value: currentAvgPremium > 0 ? currentAvgPremium.toFixed(1) : "8.6", unit: "/10", icon: Award, trend: "+0.5" },
    { label: "Session Retention", value: currentPaletteKey === 'warm' ? "87" : "92", unit: "%", icon: TrendingUp, trend: "+8%" },
  ];
        ...
        <div className="card p-5 col-span-1 md:col-span-2 lg:col-span-1">
          ...
          <div className="h-2.5 bg-[var(--surface-2)] rounded-full overflow-hidden">
            <div 
              ...
              style={{ width: currentPaletteKey === 'calm' || currentPaletteKey === 'verdant' ? '92%' : '78%' }}
            />
          </div>
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 pb-24">
        ...
        <div className="mb-12">
          <div className="flex items-end justify-between mb-4">
            ...
            <div className="text-xs text-[var(--text-muted)] hidden md:block">Click any palette to instantly transform the entire interface</div>
          </div>
